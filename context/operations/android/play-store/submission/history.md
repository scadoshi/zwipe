...
- **2026-07-24, `1.7.3`, versionCode `30`** (filter sheet current/staged split with Apply
  ...
  confirmed via bundletool. **First targetSdk 36 build**, which clears the Play "update your
...
- **2026-06-25, `1.1.0`, versionCode `8`** (Zwipe-select, deck tags, keyword
  hinter, expanded card detail, the first minor bump). Two Android-only fixes rode
  ...
  (step 1b, since dx ships its default droid). versionCode **`7` was built + smoke-tested
