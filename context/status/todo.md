...
- [ ] **Moxfield import (phase 2)** — authorized User-Agent requested via email to support@moxfield.com (sent 2026-06-10), awaiting reply. Until granted, Moxfield users are served by the text-paste importer. If approved: `POST /api/deck/{deck_id}/import/moxfield` reusing the Archidekt resolver pipeline. See `context/plans/deck-import.md`.
