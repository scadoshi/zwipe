...
The client side was fixed on `feat/single-flight-refresh` (ships as Build 26):
...
1. Build 26 approved and live on the App Store.
...
No schema migration. No client change — Build 26's `ensure_fresh` is already
...
Post-deploy: exercise the live app (Build 26) — login, use, force-quit,
