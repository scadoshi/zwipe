...
1. **Swipe stack** with the card name visible.
2. **Util-bar eye button → rules dialog** (mana glyphs, chips, P/T or loyalty).
3. **DFC flip** on a transform / MDFC card.
4. **Printing carousel** cycling alt-art / foreign printings.
