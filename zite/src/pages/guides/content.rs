...
pub static GUIDES: &[Guide] = &[
    ...
    Guide {
        ...
        blocks: &[
            ...
            Block::P("The dot on the `Filter` button means you've changed something from that default, a filter or a different sort. `Reset` undoes the change and drops you back to the default. Synergy is a separate mode, so it stays however you set it."),
