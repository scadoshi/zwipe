...
pub fn keyword_reminder(name: &str) -> &'static str {
    ...
    match key.as_str() {
        ...
        "hexproof from" => "Can't be targeted by spells or abilities of the named quality your opponents control.",
        ...
        "ward" => "When an opponent targets it, that spell or ability is countered unless they pay the ward cost.",
        "protection" => "Can't be blocked, targeted, dealt damage, enchanted, or equipped by the named quality.",
        ...
        "reconfigure" => "Pay the cost to attach this to a creature, or unattach it; on its own it's a creature.",
        ...
        "intimidate" => "Can only be blocked by artifact creatures and creatures that share a color with it.",
        ...
        "rampage" => "Whenever it becomes blocked, it gets +N/+N for each creature blocking it beyond the first.",
        "bushido" => "When it blocks or becomes blocked, it gets +N/+N until end of turn.",
        "flanking" => "Whenever a creature without flanking blocks it, that creature gets -1/-1 until end of turn.",
        "exalted" => "Whenever a creature you control attacks alone, it gets +1/+1 until end of turn.",
        "battle cry" => "Whenever it attacks, each other attacking creature gets +1/+0 until end of turn.",
        "melee" => "Whenever it attacks, it gets +1/+1 until end of turn for each opponent you attacked.",
        ...
        "mentor" => "Whenever it attacks, put a +1/+1 counter on an attacking creature with lesser power.",
        "dethrone" => "Whenever it attacks the player with the most life, put a +1/+1 counter on it.",
        "myriad" => "When it attacks, create a token copy attacking each other opponent, then exile them after combat.",
        "annihilator" => "Whenever it attacks, the defending player sacrifices that many permanents.",
        "training" => "Whenever it attacks with a creature of greater power, put a +1/+1 counter on it.",
        "enlist" => "As it attacks, you may tap a non-attacking creature to add its power to this one.",
        "mobilize" => "Whenever it attacks, create that many tapped, attacking 1/1 red Warriors, then sacrifice them after combat.",
        "boast" => "You may activate its boast ability once each turn, only if it attacked this turn.",

        // --- +1/+1 counters & growth ---
        "modular" => "Enters with N +1/+1 counters; when it dies, move them to another artifact creature.",
        "graft" => "Enters with N +1/+1 counters; when another creature enters, you may move a counter onto it.",
        "evolve" => "Whenever a creature with greater power or toughness enters under your control, put a +1/+1 counter on it.",
        "bloodthirst" => "If an opponent was dealt damage this turn, it enters with N +1/+1 counters.",
        "devour" => "As it enters, you may sacrifice creatures; it enters with N +1/+1 counters for each one.",
        "fabricate" => "When it enters, put N +1/+1 counters on it or create that many 1/1 Servo tokens.",
        "outlast" => "Tap it and pay the cost, only as a sorcery, to put a +1/+1 counter on it.",
        "renown" => "When it deals combat damage to a player, if it isn't renowned, put N +1/+1 counters on it and it becomes renowned.",
        ...
        "backup" => "When it enters, put N +1/+1 counters on a creature; if it's another creature, it also gains this one's abilities.",
        ...
        "offering" => "Cast it any time you could cast an instant by sacrificing a creature of the named type to reduce its cost.",
        ...
        "buyback" => "Pay the buyback cost as you cast it to return it to your hand as it resolves.",
        "replicate" => "Pay the replicate cost any number of times to copy the spell that many times.",
        "conspire" => "As you cast it, tap two untapped creatures that share a color with it to copy it.",
        "splice" => "As you cast an Arcane spell, reveal this from hand and pay its splice cost to add its text.",
        ...
        "prowl" => "Pay the prowl cost if you dealt combat damage with a matching creature type this turn.",
        "freerunning" => "Pay the freerunning cost if an Assassin or your commander dealt combat damage this turn.",
        "casualty" => "As you cast it, you may sacrifice a creature with high enough power to copy it.",
        "cleave" => "Pay the cleave cost to cast it without the text in brackets.",
        "compleated" => "If you pay 2 life instead of Phyrexian mana, it enters with fewer loyalty counters.",
        "sunburst" => "Enters with a +1/+1 or charge counter for each color of mana spent to cast it.",
        ...
        "bargain" => "As you cast it, you may sacrifice an artifact, enchantment, or token for a bonus.",
        ...
        "blitz" => "Cast it for its blitz cost: it gains haste and 'when it dies, draw a card', but is sacrificed at end of turn.",
        "mutate" => "Cast it onto a non-Human creature you own; they merge into one creature keeping all abilities.",
        ...
        "escape" => "Cast it from your graveyard for its escape cost and by exiling other cards from your graveyard.",
        "disturb" => "Cast its back face from your graveyard for the disturb cost, then exile it if it would leave.",
        ...
        "encore" => "Pay the cost to exile it from your graveyard, making a token copy that attacks each opponent, then sacrifice them.",
        "unearth" => "Pay the unearth cost to return it from your graveyard with haste; exile it at end of turn.",
        "scavenge" => "Exile it from your graveyard and pay the cost to put that many +1/+1 counters on a creature.",
        "recover" => "When a creature dies, pay the recover cost to return this from your graveyard to hand, or exile it.",
        "dredge" => "Instead of drawing, you may mill N cards and return this from your graveyard to your hand.",
        "soulshift" => "When it dies, you may return a Spirit with low enough mana value from your graveyard to your hand.",
        "haunt" => "When it dies, exile it haunting a creature; its ability triggers again when that creature dies.",
        ...
        "cascade" => "When cast, exile cards until you reveal a cheaper nonland card, then cast it for free.",
        "ripple" => "As you cast it, you may reveal the top N cards and cast any with the same name for free.",
        "epic" => "Copy this spell at each of your upkeeps; you can't cast other spells for the rest of the game.",
        ...
        "miracle" => "If it's the first card you drew this turn, you may reveal it and cast it for its miracle cost.",
        "split second" => "While it's on the stack, players can't cast spells or activate non-mana abilities.",
        ...
        "impending" => "Cast it for its impending cost; it enters with N time counters and isn't a creature until they're gone.",

        // --- Phasing / vanishing ---
        "phasing" => "It phases out and back each turn; while phased out it's treated as not existing.",
        "vanishing" => "Enters with N time counters; remove one each upkeep, and sacrifice it when the last is gone.",
        "fading" => "Enters with N fade counters; remove one each upkeep, and sacrifice it when you can't.",
        "cumulative upkeep" => "At each upkeep, put an age counter on it, then pay its cost per counter or sacrifice it.",
        "echo" => "Pay its echo cost at your next upkeep or sacrifice it.",

        // --- Face-down ---
        "morph" => "Cast it face down as a 2/2 for {3}; turn it face up any time for its morph cost.",
        "megamorph" => "Cast it face down as a 2/2; turn it up for its megamorph cost with a +1/+1 counter.",
        "disguise" => "Cast it face down as a 2/2 with ward {2}; turn it up any time for its disguise cost.",
        "hideaway" => "When it enters, look at the top N cards, exile one face down, and put the rest on the bottom; play it later.",

        // --- Counters & flavor mechanics ---
        "level up" => "Pay the cost as a sorcery to add a level counter, raising its stats and abilities.",
        "forecast" => "Activate its forecast ability from your hand during your main phase, once each turn.",
        "aura swap" => "Pay the cost to exchange this Aura with an Aura in your hand.",
        "champion" => "When it enters, exile another creature you control until it leaves; sacrifice it if you don't.",
        ...
        "tribute" => "As it enters, an opponent chooses to put N +1/+1 counters on it or let its other ability trigger.",
        "cipher" => "When it deals combat damage to a player, you may encode it on a creature so its controller can copy the spell.",
        "provoke" => "When it attacks, you may force a creature the defender controls to untap and block it.",
        "ninjutsu" => "Return an unblocked attacker to hand and pay the cost to put this onto the battlefield attacking.",
        ...
        "living weapon" => "When it enters, create a 0/0 Phyrexian Germ token and attach this Equipment to it.",
        "for mirrodin!" => "When it enters, create a 2/2 red Rebel and attach this Equipment to it.",
        ...
        "specialize" => "Pay the specialize cost to turn it into a single-color version with extra abilities.",
        "saddle" => "Tap creatures with total power N or more to saddle this Mount; saddled abilities work that turn.",
        ...
        "partner with" => "When it enters you may search for the named card; the two can be partner commanders.",
        ...
        "companion" => "If your deck meets its condition, once per game you may pay {3} to put it into your hand from outside the game.",

        // --- Other abilities ---
        "overload" => "You may pay the overload cost to affect everything that qualifies instead of one target.",
        "bestow" => "Cast it as an Aura for its bestow cost; if the creature leaves, it stays as a creature.",
        "awaken" => "Pay the awaken cost to also put +1/+1 counters on a land and turn it into a creature.",
        "soulbond" => "Pair it with another creature when either enters; while paired, both gain a bonus ability.",
        "amplify" => "As it enters, reveal creature cards of the matching type from hand to put that many +1/+1 counters on it.",
        "ravenous" => "It enters with X +1/+1 counters; if X is 5 or more, draw a card when it enters.",
        "banding" => "It can attack or block in a band, and you choose how blocked creatures assign their combat damage.",
        "ingest" => "Whenever it deals combat damage to a player, that player exiles the top card of their library.",
        "devoid" => "It has no color.",
        "demonstrate" => "When you cast it, you may copy it, then an opponent of your choice also copies it.",
        "gift" => "As you cast it, you may promise an opponent a gift; if you do, you gain a bonus.",
        "umbra armor" => "When the enchanted creature would be destroyed, instead remove all damage from it and destroy this Aura.",
        "ascend" => "If you control ten or more permanents, you get the city's blessing for the rest of the game.",
        "fuse" => "You may cast both halves of this split card together from your hand.",
        "transmute" => "Discard it and pay its transmute cost to search your library for a card with the same mana value.",
        "transfigure" => "Sacrifice it and pay its cost to search your library for a creature with the same mana value.",

        // --- Keyword actions (useful shorthand) ---
        "regenerate" => "The next time it would be destroyed this turn, instead tap it, remove it from combat, and heal it.",
        "counter" => "Counter a spell or ability so it doesn't resolve and is put into its owner's graveyard.",
        "seek" => "Search your library at random for a card matching the description and put it into your hand, without revealing your library.",
        "scry" => "Look at the top N cards of your library; put any on the bottom and the rest back on top.",
        "surveil" => "Look at the top N cards of your library; put any into your graveyard and the rest back on top.",
        ...
        "proliferate" => "Choose any permanents or players with a counter and give each another counter of a kind it already has.",
        "explore" => "Reveal the top card: if a land, put it in hand; otherwise put a +1/+1 counter on the creature and keep or bin the card.",
        ...
        "amass" => "Put N +1/+1 counters on an Army you control, creating a 0/0 Army first if you have none.",
        "connive" => "Draw N cards, then discard N; put a +1/+1 counter on it for each nonland card discarded.",
        "goad" => "The creature must attack each combat if able, and a player other than you if able.",
        "manifest" => "Put the top card face down as a 2/2; turn it face up for its cost if it's a creature card.",
        "manifest dread" => "Look at the top two cards, manifest one and put the other into your graveyard.",
        "cloak" => "Put a card face down as a 2/2 with ward {2}; turn it up any time for its mana cost.",
        ...
        "monstrosity" => "If it isn't monstrous, put N +1/+1 counters on it and it becomes monstrous.",
        "detain" => "Until your next turn, that permanent can't attack, block, or have its abilities activated.",
        "incubate" => "Create an Incubator token with N +1/+1 counters that can flip into a 0/0 Phyrexian artifact creature.",
        "fight" => "Two creatures each deal damage equal to their power to the other.",
        "clash" => "You and an opponent reveal your top card; the one with the higher cost wins, and you may bottom yours.",
        ...
        "venture into the dungeon" => "Enter or advance through a dungeon, taking the next room's effect.",
        "discover" => "Exile cards from the top until a nonland with mana value N or less, then cast it free or put it in hand.",
        ...
        "collect evidence" => "Exile cards with total mana value N or more from your graveyard as a cost.",
        ...
        "time travel" => "Add or remove a time counter on each suspended card and Saga you control.",
        "behold" => "Reveal or note a creature of the named type from your hand or battlefield as a cost.",
        ...
        "spell mastery" => "Active if two or more instant and/or sorcery cards are in your graveyard.",
        ...
        "kinship" => "At your upkeep you may reveal the top card; get a bonus if it shares a creature type with it.",
        ...
        "sweep" => "Return any number of the named lands you control for an effect that scales with how many.",
        "tempting offer" => "You get an effect; each opponent may let you do it again to also copy it for themselves.",
        ...
        "celebration" => "Active if two or more nonland permanents entered under your control this turn.",
        "valiant" => "Triggers the first time each turn it becomes the target of a spell or ability you control.",
        "flurry" => "Triggers whenever you cast your second spell each turn.",
        "eerie" => "Triggers when an enchantment enters or a face-down permanent turns up under your control.",
        ...
        "void" => "Active if a nonland permanent left the battlefield or a spell or ability was countered this turn.",
        "will of the planeswalkers" => "Players vote, and the option with the most votes happens.",

        // --- Token & game actions ---
        "treasure" => "Create a Treasure token: an artifact you can sacrifice for one mana of any color.",
        "food" => "Create a Food token: an artifact you can sacrifice, paying {2} and tapping it, to gain 3 life.",
        ...
        "assemble" => "Put a Contraption from your Contraption deck into play (an Un-set mechanic).",
        ...
        "open an attraction" => "Put an Attraction from your Attraction deck onto the battlefield (an Unfinity mechanic).",
        "roll to visit your attractions" => "Roll a six-sided die to see which of your Attractions trigger (an Unfinity mechanic).",
        "set in motion" => "Put a scheme card into motion to start its effect (an Archenemy mechanic).",
        "abandon" => "Remove an ongoing scheme from the game (an Archenemy mechanic).",

        // --- Recent set mechanics ---
        "warp" => "Cast it for its cheaper warp cost to use it now, then exile it; you can cast it from exile later.",
        "station" => "Tap creatures to add station counters to it; it unlocks stronger abilities at certain thresholds.",
        "max speed" => "Its bonus is active once you reach max speed (your Speed has climbed to 4).",
        "start your engines!" => "You get Speed 1; your Speed can rise to a maximum of 4, powering up Speed abilities.",
        "double team" => "When it attacks, if it isn't a token, make a copy of it in your hand; then both lose double team.",
        "harmonize" => "You may cast it again from your graveyard for its harmonize cost (a Final Fantasy mechanic).",
        "mayhem" => "If it was discarded, you may cast it from your graveyard for its mayhem cost, then exile it.",
        "job select" => "Choose a job for it as it enters, granting matching abilities (a Final Fantasy mechanic).",
        "web-slinging" => "Cast it for its web-slinging cost by returning or tapping a creature (a Spider-Man mechanic).",
        "firebending" => "Channel Fire creatures to power its firebending ability (an Avatar mechanic).",
        "waterbend" => "Channel Water creatures to power its waterbending ability (an Avatar mechanic).",
        "airbend" => "Channel Air creatures to power its airbending ability (an Avatar mechanic).",
        "earthbend" => "Channel Earth creatures to power its earthbending ability (an Avatar mechanic).",
        ...
        _ => "A special keyword from this card's set. Check the card's text to see exactly what it does.",
    }
}
...
mod tests {
    ...
    fn known_keywords_get_specific_reminders() {
        for kw in ["Flying", "Trample", "Mill", "Foretell", "Treasure"] {
            assert_ne!(keyword_reminder(kw), FALLBACK, "{kw} should have a real hint");
        }
    }
