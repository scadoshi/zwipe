...
> Note: name "Magic: The Gathering" freely here, since this is a private business
...
3. **Per-card buy links** (new feature): a "Buy ↗" on individual cards in search /
   the deck list, not just the whole-deck mass entry, to impulse-buy the card you
