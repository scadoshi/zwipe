...
Drafted from the 1.10.2 block in `zwipe-core/src/content/changelog/mod.rs`, compressed to fit Play's cap. All six changelog entries are represented; the in-app copy carries the fuller wording. Uses the in-app term "command zone" rather than working around it.

Kept a margin rather than writing to exactly 500: the two consoles need not agree on how they count a newline, and a rejection at paste time is a bad place to find out.
