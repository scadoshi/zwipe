...
impl DeckTag {
    ...
    pub fn oracle_tag_slugs(&self) -> &'static [&'static str] {
        match self {
            ...
            Self::Clone => &["copy-creature", "clone", "copy-self", "shapesharing"],
            ...
            Self::Energy => &["energy-generator", "counter-fuel-energy"],
            Self::ExtraCombats => &["extra-combat-phase"],
            ...
            Self::Mill => &["mill-opponent", "mill-any", "mill-each", "mill-exile"],
            ...
            Self::Hatebears => &["hatebear", "tax-attack", "cast-tax", "toll"],
            Self::Landfall => &[
                "landfall",
                "land-ramp",
                "multi-land-ramp",
            ...
            Self::Lifedrain => &["drain-life", "blood-artist-ability", "life-loss-matters"],
            Self::Monarch => &["monarch-matters"],
            Self::Ping => &["pinger", "combat-neutral-damage-trigger"],
            Self::Spellslinger => &[
            ...
            Self::Poison | Self::Toxic | Self::Infect => &[
                "poisonous",
                "synergy-poison",
                "poison-opponents",
                "gives-infect",
            ...
            Self::Flying => &["gives-flying", "gains-flying", "synergy-flying"],
