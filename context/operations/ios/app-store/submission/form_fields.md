...
Just shipped: undo for deck edits, a quick-add search bar, and card art across your deck list. Free, no ads.
...
This is a Magic: The Gathering deck builder. Use the provided test account to log in, create decks, and browse cards. The app requires an internet connection to search and browse cards.
...
12 screenshots in this directory, taken on iPhone 11 Pro Max simulator (1242×2688px).
