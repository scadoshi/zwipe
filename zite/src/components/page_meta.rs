...
///
/// `path` should start with `/` and is appended to `https://zwipe.net` for
...
pub fn PageMeta(title: String, description: String, path: String) -> Element {
    let canonical = format!("https://zwipe.net{path}");
    ...
    rsx! {
        ...
        document::Meta { property: "og:image", content: "https://zwipe.net/assets/og-default.png" }

        // Twitter / X
        document::Meta { name: "twitter:card", content: "summary_large_image" }
        document::Meta { name: "twitter:title", content: "{full_title}" }
        document::Meta { name: "twitter:description", content: "{description}" }
        document::Meta { name: "twitter:image", content: "https://zwipe.net/assets/og-default.png" }
    }
}
