...
// use crate::domain::auth::models::{AuthenticateUserError, RegisterUserError};
...
//                 "A user with that name or email already exists".to_string(),
//             ),
//             RegisterUserError::InvalidRequest(e) => {
//                 Self::UnprocessableEntity(format!("Invalid request {}", e))
//             }
//             e => {
//                 tracing::error!("{:?}\n{}", e, e.backtrace());
...
//     fn from(e: AuthenticateUserError) -> Self {
//         match e {
//             AuthenticateUserError::UserNotFound => Self::UnprocessableEntity(
//                 "A user with that username or email was not found".to_string(),
//             ),
//             AuthenticateUserError::InvalidPassword => Self::UnprocessableEntity("Invalid password"),
//             e => {
//                 tracing::error!("{:?}\n{}", e, e.backtrace());
//                 Self::InternalServerError("Internal server error".to_string())
//             }
...
// impl From<asdf> for ApiError {
//     fn from(e: AuthenticateUserError) -> Self {
//         match e {
//             asdf::asdf => Self::UnprocessableEntity("".to_string()),
//             asdf::asdf => Self::UnprocessableEntity("Invalid password"),
//             e => {
//                 tracing::error!("{:?}\n{}", e, e.backtrace());
//                 Self::InternalServerError("Internal server error".to_string())
//             }
